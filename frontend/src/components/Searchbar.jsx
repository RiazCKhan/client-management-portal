export default function Searchbar() {
  return (
    <section className="flex justify-center dark:bg-gray-700">
      <form className="w-1/2">
        ...
        <div className="relative">
          ...
          <input type="search" id="default-search" className="block p-4 pl-10 w-full text-sm text-gray-900 bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search Clients..." required />
